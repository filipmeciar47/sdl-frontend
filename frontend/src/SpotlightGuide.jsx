...
export const GUIDE_STEPS = {
  ...
  features: [
    ...
    { id: "tut-feat-actions", pos: "top",
      ...
      text: "Rozviňte ju, ukážte, ako vznikla z predchádzajúcej úrovne, alebo kam vedie vo svojich dôsledkoch." },
    { id: "tut-feat-axis", pos: "top",
      bold: "Os úrovne.",
      text: "Individualistická (express-self) alebo kolektívna (deny-self). Špirála prirodzene striedá póly." },
    ...
    { id: "tut-feat-export", pos: "top",
      ...
      text: "Dokument so všetkými perspektívami — pripravený na tlač alebo uloženie ako PDF." },
    { id: "tut-feat-newtopic", pos: "top",
      bold: "Nová téma.",
      text: "Vymaže všetko a vráti vás na začiatok pre novú tému." },
  ],
};
